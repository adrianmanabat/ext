...
//import tooltwist.adrian.productionHelpers.GooglemapProductionHelper;
...
public class GooglemapWidget extends WbdWidgetController
{
	...
	protected void init(WbdWidget instance) throws WbdException
	{
		...
		instance.defineProperty(new WbdStringProperty("width", null, "Set Width", ""));
		instance.defineProperty(new WbdStringProperty("text", null, "Set Height", ""));
