...
//import tooltwist.adrian.productionHelpers.LinkProductionHelper;
 ...
 * Link Widget
 */
public class LinkWidget extends WbdWidgetController
{
	private static final String SNIPPET_PREVIEW = "link_preview.html";
	private static final String SNIPPET_DESIGN = "link_design.html";
	private static final String SNIPPET_PRODUCTION = "link_production.jsp";
...
//				new StylesheetCodeInserter(instance.miscellaneousFilePath(generator, "link_cssHeader.css")),
			};
...
//				new JavascriptCodeInserter(instance.miscellaneousFilePath(generator, "link_jsHeader.js")),
...
//				codeInserterList.add(WbdProductionHelper.codeInserter(instance, LinkProductionHelper.class.getName(), productionHelperParams));
//				codeInserterList.add(new PageImportCodeInserter(LinkProductionHelper.class.getName()));
			}
		}
	...
	private SnippetParam[] getSnippetParams(WbdGenerator generator, WbdWidget instance, UimData ud) throws WbdException {
		String myText = instance.getProperty("text", null);
		String myLink = instance.getProperty("link", null);
		SnippetParam[] params = {
			new SnippetParam("myText", myText),
			new SnippetParam("myLink", myLink)
		};
		return params;
	}
}
